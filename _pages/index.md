...
# News
- *2025.05*: 🔥 New preprints on [Speculative Thinking](https://arxiv.org/abs/2504.12329), [SELF](https://arxiv.org/abs/2505.17296), and [Longer Context, Deeper Thinking](https://www.arxiv.org/abs/2505.17315) form my group are out!
- *2025.05*: 🔥 Two papers on [💯-LongBench](https://arxiv.org/abs/2505.19293) and [CausalRAG](https://arxiv.org/abs/2503.19878) accepted by ACL2025 Findings!
- *2025.04*: Invited to serve as an Area Chair for NeurIPS2025!
- *2025.02*: New preprint on [Thinking Preference Optimization](https://arxiv.org/abs/2502.13173) is out!
- *2025.02*: One paper on [You Only Debias Once](https://openreview.net/forum?id=XYMWd1wNlf) is accepted by CPAL 2025 (Proceedings Track) Oral!
...
- <details> <summary>More</summary>
  <ul>
    <li><em>2024.05:</em> <a href="https://arxiv.org/pdf/2312.15194">One paper</a> is accepted by ACL2024!</li>
    <li><em>2024.04:</em> <a href="https://arxiv.org/abs/2401.01325">LLM Maybe LongLM: Self-Extend LLM Context Window Without Tuning</a> is accepted by ICML2024!</li>
    <li><em>2024.04:</em> My <a href="https://huggingface.co/ahxt/LiteLlama-460M-1T">LiteLLaMa</a> has been downloaded over 230K times on HuggingFace!</li>
    <li><em>2024.04:</em> Honored to receive the <a href="https://www.janestreet.com/join-jane-street/programs-and-events/grf-profiles-2024/">Jane Street Graduate Research Fellowship Award Honorable Mention</a>.</li>
    <li><em>2024.03:</em> Implemented <a href="https://github.com/openai/triton">Triton</a> based flash self-extend. Please try <a href="https://github.com/datamllab/LongLM/blob/master/self_extend_patch/selfextend_flash_attn_triton.py">FlashSelfExtend</a>!</li>
    <li><em>2024.01:</em> One paper on <a href="https://arxiv.org/pdf/2306.09468.pdf">Fairness Benchmark</a> accepted by ICLR2024!</li>
    <li><em>2024.01:</em> Our <a href="https://arxiv.org/abs/2304.13712">Survey on LLMs</a> accepted by TKDD!</li>
    <li><em>2024.01:</em> New preprint <a href="https://arxiv.org/abs/2401.01325">LLM Maybe LongLM: Self-Extend LLM Context Window Without Tuning</a>!</li>
...
<!-- > - 01/21/2025 » [LLM Tech Report Notes (updated on 01/21/2025)](/blog/2025-01-21-llm-tech-reoport/)
> - 12/30/2024 » [Reproduce the inference time scaling exp](/blog/2024-12-30-inference-time-scaling-exp/)
> - 12/12/2024 » [Cross-entropy loss and its optimization](/blog/2024-12-12-celoss/)
> - 11/20/2024 » [Graph Convolution ≈ Mixup](/blog/2024-11-20-graph-convolution-mixup/)
> - 10/20/2024 » [Attention and its gradient](/blog/2024-10-20-attention/)
> - 10/19/2024 » [Softmax and its triton implementation](/blog/2024-10-19-softmax/) -->
...
- Longer Context, Deeper Thinking: Uncovering the Role of Long-Context Ability in Reasoning [[pdf](https://arxiv.org/abs/2505.17315)]
  - Wang Yang, Zirui Liu, Hongye Jin, Qingyu Yin, Vipin Chaudhary, **Xiaotian Han**
  - May 2025

- SELF: Self-Extend the Context Length With Logistic Growth Function [[pdf](https://arxiv.org/abs/2505.17296)]
  - Phat Thanh Dang, Saahil Thoppay, Wang Yang, Qifan Wang, Vipin Chaudhary, **Xiaotian Han**
  - May 2025

- Speculative Thinking: Enhancing Small-Model Reasoning with Large Model Guidance at Inference Time [[pdf](https://arxiv.org/abs/2504.12329)]
...
- 💯-LongBench: Are de facto Long-Context Benchmarks Literally Evaluating Long-Context Ability? [[pdf](https://arxiv.org/abs/2505.19293)]
  - Wang Yang, Hongye Jin, Shaochen Zhong, Song Jiang, Qifan Wang, Vipin Chaudhary, **Xiaotian Han**
  - ACL2025 Findings

- CausalRAG: Integrating Causal Graphs into Retrieval-Augmented Generation [[pdf](https://arxiv.org/abs/2503.19878)]
  - Nengbo Wang, **Xiaotian Han**, Jagdip Singh, Jing Ma, Vipin Chaudhary
  - ACL2025 Findings

- You Only Debias Once: Towards Flexible Accuracy-Fairness Trade-offs at Inference Time [[pdf](https://openreview.net/forum?id=XYMWd1wNlf)]
  - **Xiaotian Han**, Tianlong Chen, Kaixiong Zhou, Zhimeng Jiang, Zhangyang Wang, Xia Hu
  - CPAL2025, <span style="color:red">Oral</span>
