...
I am an assistant professor in the Department of Computer and Data Sciences at Case Western Reserve University start form Fall 2024. Previously, I obtained my Ph.D. degree in the Department of Computer Science and Engineering at <a href="https://www.tamu.edu" target="_blank">Texas A&M University</a> and was working at the DATA Lab under the supervision of Prof. <a href="https://cs.rice.edu/~xh37/index.html" target="_blank">Xia (Ben) Hu</a> since 2019. My research interests lie in the general area of artifiicial intelligence, machine learning and data science, and recently Large Language Models (LLM). Here is my [CV](/files/Xiaotian_CV.pdf).

---

<span style="color:red">[Prospective Students]</span> I'm seeking multiple self-motivated students (Ph.D., Internship) for Spring/Fall 2025. If you're interested in Efficient LLM, Understanding LLM, LLM Agents, Graph Foundation Models, please email me at <a href="mailto:xhan.hire@gmail.com" target="_blank">xhan.hire@gmail.com</a> with your CV and transcripts, for more details, refer to [Group](/group.html).
...
- ``TMLR2024`` On the Equivalence of Graph Convolution and Mixup  [[PDF]](https://openreview.net/pdf?id=koC6zyaj73)
